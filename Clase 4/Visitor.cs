...
class Visitor(List<ErroresDTO> listaErrores) : AnalizadorLexicoBaseVisitor<Object> {
    ...
    public override Object VisitAsignacionVar([NotNull] AnalizadorLexicoParser.AsignacionVarContext context) {
        ...
        if (signo == ":=") {
            ...
            //Validar tipo de dato 
                //Si tipo de dato es correcto
                    //Asignar variabke
                //Tipo de datos incorrecti
                    //Error semantico
            //listaErrores.Add(new ErroresDTO("Error semantico", "Descripcion", context.signo.Line, context.signo.Column));
