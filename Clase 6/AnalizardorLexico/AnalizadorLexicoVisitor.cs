...
public interface IAnalizadorLexicoVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="AnalizadorLexicoParser.instruccion_funciones"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitInstruccion_funciones([NotNull] AnalizadorLexicoParser.Instruccion_funcionesContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="AnalizadorLexicoParser.instruccion_ejecutar_funciones"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitInstruccion_ejecutar_funciones([NotNull] AnalizadorLexicoParser.Instruccion_ejecutar_funcionesContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="AnalizadorLexicoParser.parametros_funciones"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitParametros_funciones([NotNull] AnalizadorLexicoParser.Parametros_funcionesContext context);
	/// <summary>
