...
public partial class AnalizadorLexicoBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IAnalizadorLexicoVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitInstruccion_funciones([NotNull] AnalizadorLexicoParser.Instruccion_funcionesContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitInstruccion_ejecutar_funciones([NotNull] AnalizadorLexicoParser.Instruccion_ejecutar_funcionesContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitParametros_funciones([NotNull] AnalizadorLexicoParser.Parametros_funcionesContext context) { return VisitChildren(context); }
	/// <summary>
